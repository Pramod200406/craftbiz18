  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <span className="text-xs font-bold uppercase tracking-wider text-indigo-600">Enterprise Procurement Hub</span>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-2 bg-slate-100 hover:bg-slate-200 text-indigo-900 text-xs font-bold rounded-xl border border-slate-300 transition-all flex items-center gap-1"
          >
            <UserPlus className="w-3.5 h-3.5" />
            <span>New Buyer</span>
          </button>

          <div className="flex items-center gap-2 bg-slate-100 p-1.5 rounded-2xl text-xs sm:text-sm font-bold">
            <button
              onClick={() => setActiveTab('marketplace')}
              className={`px-4 py-2 rounded-xl transition-all ${
                activeTab === 'marketplace' ? 'bg-indigo-600 text-white shadow' : 'text-slate-600 hover:text-slate-950'
              }`}
            >
              🛍️ Marketplace
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-xl transition-all flex items-center gap-1.5 ${
                activeTab === 'matches' ? 'bg-indigo-600 text-white shadow' : 'text-slate-600 hover:text-slate-950'
              }`}
            >
              <span>🤝</span>
